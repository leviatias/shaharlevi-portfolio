...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> ShaharLeviAtias@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/leviatias" target="_blank" class="text-violet-400">Shahar_LeviAtias
                <sup class="">
                    <span class="text-md scale-75 pl-0.5">
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/shachar-levi-atias-2a7495239/" target="_blank" class="text-violet-400">Shahar_LeviAtias
                <sup class="">
